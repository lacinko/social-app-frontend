    ...
    <div className="pt-4">
      <form onSubmit={handleSubmit(onSubmitHandler)}>
        <L_Label
          ...
          htmlFor="name"
          className="font-semibold text-lg pt-6 text-gray-900"
        >
          Name
        </L_Label>
        ...
        <RadioGroup id="type" className="flex flex-col gap-5 pt-3">
          ...
          <div className="flex gap-2 items-start">
            ...
            <div className="flex gap-2">
              ...
              <p className="text-sm leading-6 flex flex-col text-gray-900">
                <span className="font-medium pr-2">Restricted</span> Anyone can
                view this collection, but only approved users can post
              </p>
            </div>
          </div>
          <div className="flex gap-2 items-start">
